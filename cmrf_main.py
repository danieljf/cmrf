...
def process(options, trainCollection, devCollection):
    ...
    DCG_result_path = os.path.join(rootpath, devCollection, 'DCG', method, feature)
...
def main(argv=None):
    ...
    parser.add_option("--method", default='se', type="string", help="method:se, t2i, i2t  (default: se)")
    ...
    parser.add_option("--qrysim", default='O', type="string", help="query similarity method (default: O   available: O, OI, BowT )")
    parser.add_option("--nnimagefile", default='id.100nn.dis.txt', type="string", help="query similarity method (default: O   available: O, OI, BowT )")
    parser.add_option("--imageclickfile", default='image.clicked.txt', type="string", help="query similarity method (default: O   available: O, OI, BowT )")

    # text2image parameters
    parser.add_option("--nnqueryfile", default='qid.100nn.score.txt', type="string", help="query similarity method (default: O   available: O, OI, BowT )")
    parser.add_option("--queryclickfile", default='query.clicked.txt', type="string", help="query similarity method (default: O   available: O, OI, BowT )")
